...
\begin{center}
    \begin{tikzpicture}[block/.style={shape=rectangle, shape aspect=1.61, rounded corners},
                        file/.style={minimum height=1cm, fill=blue!20, draw=blue},
                        bin/.style={minimum height=3cm, fill=red!20, draw=red}]
    \node[block, bin] at (0,0) {\LaTeX{}};
    \end{tikzpicture}
\end{center}
\end{frame}
