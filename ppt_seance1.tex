...
\includegraphics[width=11cm]{img/fenetre_moz_log} % image de X cm de large
...
\begin{figure} %debut de l'environnement figure
\centering %figure centree
\includegraphics[width=11cm]{img/miktex_1} % image de X cm de large
%\caption{Titre de la figure} %titre de la figure
%\label{titre_fig} %label de la figure (ex voir figure W)
\end{figure} %fin de l'environnement figure
...
\begin{figure} %debut de l'environnement figure
\centering %figure centree
\includegraphics[width=9cm]{img/mactex_1} % image de X cm de large
%\caption{Titre de la figure} %titre de la figure
%\label{titre_fig} %label de la figure (ex voir figure W)
\end{figure} %fin de l'environnement figure
...
\begin{figure} %debut de l'environnement figure
\centering %figure centree
\includegraphics[width=10cm]{img/texlive_1} % image de X cm de large
%\caption{Titre de la figure} %titre de la figure
%\label{titre_fig} %label de la figure (ex voir figure W)
\end{figure} %fin de l'environnement figure
...
\item\LaTeX ignore les sauts de lignes et les espaces multiples (mise en forme automatique à la compilation)
\end{itemize}

\begin{lstlisting}
blabla bgnhoireg jerifjoiref

vjirjev jirjoiji okpokpok kokok


kkoooooo kooooooooooooooooo
\end{lstlisting}
...
Regardez sur votre document \LaTeX  l'effet des saut de ligne...
